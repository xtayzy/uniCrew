...
function HomePage() {
    ...
    return (
        <>
            <SEOHead 
                title="UniCrew.kz — Найди команду для студенческих проектов | Хакатоны, Дипломы, Стартапы"
                description="UniCrew.kz — платформа для поиска команды студентам. Найди участников для дипломных работ, хакатонов, стартапов и учебных проектов. Бесплатная регистрация."
                keywords="unicrew kz, студенческие проекты, команда, хакатон, дипломная работа, стартап, поиск команды, студенты, проекты, казахстан"
            />
